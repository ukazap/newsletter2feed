...
ActiveRecord::Schema[8.1].define(version: 2026_01_18_034044) do
  ...
  create_table "feed_entries", force: :cascade do |t|
    ...
    t.index ["public_id"], name: "index_feed_entries_on_public_id", unique: true
  end

  create_table "feed_hits", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.integer "feed_id", null: false
    t.index ["feed_id", "created_at"], name: "index_feed_hits_on_feed_id_and_created_at"
    t.index ["feed_id"], name: "index_feed_hits_on_feed_id"
  end
  ...
  add_foreign_key "feed_hits", "feeds"
end
